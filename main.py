...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'sarim639745@gmail.com' ")
...
message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System BY Saarim Saifi" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
message3.place(x=120, y=10)
